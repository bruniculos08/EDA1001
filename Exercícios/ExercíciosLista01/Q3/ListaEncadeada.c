    ...
    do{
        ...
        switch(option){
            ...
            case 8:
                ...
                break;
            case 9:
                printf("\nDigite a posicao do valor(1) a ser trocado: ");
                scanf("%i", &n);
                printf("\nDigite a posicao do valor(2) a ser trocado: ");
                scanf("%i", &b);
                lista = trocaNodo(lista, ponteiro(lista, n), ponteiro(lista, b));
                break;
            case 0:
                break;
            default:
